    ...
    return ( 
        <div className="about-cont">
            <div className="about-profile">
                ...
                <div className="span"></div>
                <p className="texto-about">Departamentos totalmente equipados. Alquilá en Argentina por día, semana, mes o el tiempo que quieras.</p>
            ...
            <div className="about-profile">
                ...
                gestionarla? Sumala a Best y nosotros nos encargamos de todo.
                </p>
